...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['BaseBtn']) ){
	...
	if (DeviceGroup::regexDgID($dg_id)){
		...
		echo "<script> alert('None thing was selected')</script>";
	}
}
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-ticket fa-fw"></i> Form Example
                </div>
                <div class="panel-body">
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tr>
                            ...
                            <td>
								<button class="btn btn-danger btn-md pull-right" tabindex="4" name="BaseBtn">BaseBtn</button>
							</td>
						</tr>
					</table>
					</form>
        ...
        <div class="col-md-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-calculator fa-fw"></i> Side menu
                </div>
                <div class="panel-body">
                </div>
                <!-- /.panel-body -->
